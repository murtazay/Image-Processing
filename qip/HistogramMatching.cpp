...
QGroupBox *HistogramMatching::controlPanel()
{
    ...
    connect(m_slider , SIGNAL(valueChanged(int)), this,       SLOT(setDeg(int)));
...
void HistogramMatching::histmatch(ImagePtr I1, int deg, ImagePtr I2)
{
...
void HistogramMatching::setDeg(int)
{
